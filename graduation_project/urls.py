...
urlpatterns = [
    ...
    path('project/<slug:slug>/delete/', views.delete_proejct, name='delete_project'),  # تأكد من اسم الرابط
    ...
    path('temporary_reject_project/<int:project_id>/', views.temporary_reject_project, name='temporary_reject_project'),
